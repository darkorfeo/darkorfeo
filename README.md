            ...
            client.sendFileFromUrl(from, animek
{
    ...
    "STRINGS": {
        ...
        "_plugin": {
            ...
            "INSTALLED_FROM_REMOTE": "✅*Plugins you installed externally:*\n",
            ...
            "DELETED": "*✅ Module successfully deleted! You must restart for the changes to take effect.*"
        },
        "admin": {
        ...
        "greetings": {
            ...
            "W_ENABLED": "*✅Welcome Message {}*",
            "G_ENABLED": "*✅GOODBYE Message {}*",
            "B_ENABLED": "*✅BANBYE Message {}*",
            "ENABLE": "Enabled.",
            "DISABLE": "Disabled.",
            ...
            "BANBYE_ALREADY_SETTED": "*✅ Banbye message has been set!*\n*Message:* ```",
            "NEED_BANBYE_TEXT": "*You must write a message to set up the banbye message.*\n*Example:* ```.banbye Goodbye!```",
            "BANBYE_DELETED": "*✅ Banbye message has been deleted successfully!*",
            "BANBYE_SETTED": "*✅ Banbye message has been setted successfully!*",
